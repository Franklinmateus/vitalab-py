...
urlpatterns = [
    ...
    path('gerenciar_pedidos/', views.gerenciar_pedidos, name="geremciar_pedidos"),
    ...
    path('solicitar_senha_exames/<int:exame_id>', views.solicitar_senha_exame, name="solicitar_senha_exame")
]